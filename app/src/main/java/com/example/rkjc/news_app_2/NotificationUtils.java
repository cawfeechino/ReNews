...
public class NotificationUtils {
    ...
    public static void newsPush(Context context){
        ...
        NotificationCompat.Builder notificationBuilder = new
                ...
                .setContentText("You got news onii-chan!")
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        "You got news onii-chan!"))
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        ignoreReminderIntent.setAction(UpdateService.ACTION_DISMISS_NOTIFICATION);
        ...
        NotificationCompat.Action ignoreReminderAction = new NotificationCompat.Action(R.drawable.why, "Close", ignoreReminderPendingIntent);
